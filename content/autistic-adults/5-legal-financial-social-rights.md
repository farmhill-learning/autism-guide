...
4. Attend the medical board assessment when called; cooperate with any tests.

5. Download/collect the disability certificate and UDID card, and keep multiple copies safely.
...
* Education and exams: extra time, scribes, flexible attendance, reasonable accommodation in colleges and training institutes.

* Employment: reservations (in government), reasonable accommodation (clear instructions, schedule flexibility, environment adjustments), protection from discrimination.

* Public services: priority in queues, accessible communication, non‑discrimination by banks, hospitals, government offices.

**Practical steps:**

1. When approaching a college, employer, or service, share the certificate and a short note (or letter from a professional) explaining your support needs (e.g., written instructions, quiet space, flexible timing).

2. If accommodation is refused, ask in writing, referring to the relevant RPWD sections; many handbooks summarise these in plain language.

3. Keep a simple file (physical or digital) with: diagnosis, certificate, UDID, school/college letters, employer letters, and any written communication about accommodations.
...
* National Trust schemes like GHARAUNDA (group homes), SAMARTH (respite/residential care), NIRAMAYA (health insurance).

* State disability pensions, travel concessions, scholarships, skill‑training programmes.

**Practical actions:**

1. Visit your District Disability Rehabilitation Centre (DDRC) or District Social Welfare/Empowerment office with your UDID and ask for a list of local schemes for adults with autism.

2. Use curated online lists of schemes (many NGOs host updated summaries) to cross‑check what you might be eligible for.

3. For housing and long‑term care, specifically ask about National Trust residential/group‑home options and how to enrol.
...
3. Link trust income or savings to concrete supports (e.g., group home fees, personal attendants, therapy, assistive tech).

### Step 6: Build advocacy and community around you

Rights are easier to use when you are not alone.

* Join local or online autism/disability groups that share experiences on certificates, schemes, and guardianship. Many parents’ groups and autistic‑led collectives now actively guide each other through RPWD and National Trust processes.

* Use accessible guides (like the autism.farmhill.in articles or NGO handbooks) as reference when filling forms or speaking to officials.
...
1. Does this step increase the autistic adult’s control over their life—choices, money, time, relationships?

2. Are supports being designed with the autistic person’s input, at a pace and in a format they can engage with?
