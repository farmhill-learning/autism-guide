...
1. Child echoes “ice cream” after seeing a van.  
   **My response:** ___________________________________________  
...
2. For this child, what might spontaneous communication look like (even if it is small): a look, a gesture, a picture, a single word, a device button?  
   _________________________________________________________  

3. During sessions, when do you tend to “push for answers” instead of staying responsive and following the child’s lead?  
   _________________________________________________________  

4. In your next session with this theme, write one thing you will do that is:  

   - A direct elicitation (e.g., “What do you want?”, modeling a phrase):  
     _________________________________________________________  

   - A responsive interaction (e.g., noticing and commenting on the child’s action, expanding what they communicated):  
     _________________________________________________________  

5. After that session, briefly note:  

   - A moment where the child communicated spontaneously (in any form):  
     _________________________________________________________  

   - What you were doing just before that moment (direct prompting, playing, waiting, following their lead, etc.):  
     _________________________________________________________  
...
Choose one concept: __________________________  
...
- Listening: _______________________________________________  
- Expressive communication: _________________________________  
- Receptive understanding: __________________________________  
- Play or pretend: _________________________________________  
- Literacy, if appropriate: __________________________________  

Choose at least three communicative functions to target:

- Request: ________________________________________________  
- Refuse: _________________________________________________  
- Comment: _______________________________________________  
- Express feeling: _________________________________________  
...
- C**oping scripts:** “I scared → help”, “too loud → break”.  
...
**Child/Initials:** ____________________  
